...
export BUILD_PLATFORM=${BUILD_PLATFORM:-centos71}
export BUILD_SKU
export BUILD_BRANCH
export BUILD_ID
...
export BUILD_SKU=${BUILD_SKU:-kilo}
...
date
sudo bash -x ${BUILD_HOST_INSTALLERS}/pkg_install_centos71.sh
